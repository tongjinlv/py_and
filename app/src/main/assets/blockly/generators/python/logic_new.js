...
goog.provide('Blockly.Python.logicnew');

goog.require('Blockly.Python');


Blockly.Python['controls_if_new'] = function(block) {
...
Blockly.Python['controls_ifelse_new'] = Blockly.Python['controls_if_new'];

Blockly.Python['logic_compare_new'] = function(block) {
  // Comparison operator.
  var OPERATORS = {
    'EQ': '==',
    'NEQ': '!=',
...
Blockly.Python['logic_operation_new'] = function(block) {
  // Operations 'and', 'or'.
...
Blockly.Python['logic_negate_new'] = function(block) {
  // Negation.
...
Blockly.Python['logic_boolean_new'] = function(block) {
  // Boolean values true and false.
  var code = (block.getFieldValue('BOOL') == 'TRUE') ? 'True' : 'False';
  return [code, Blockly.Python.ORDER_ATOMIC];
};

Blockly.Python['logic_null_new'] = function(block) {
  // Null data type.
  return ['None', Blockly.Python.ORDER_ATOMIC];
};

Blockly.Python['logic_ternary_new'] = function(block) {
  // Ternary operator.
